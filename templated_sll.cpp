//To implement the singly linked list class using template
#include<iostream>
#include<string>
...
int main()
{ SLinkedList<string> sll; //creating a linked list of string type
  string ele;
  char ch;
 do { 
           cout<<"\n---------------Menu-------------------\n";
           cout<<"1. check if empty list \n";
           cout<<"2. print front element  \n";
           cout<<"3. add in front   \n";
           cout<<"4. add in back  \n";
           cout<<"5. remove form front  \n";
           cout<<"6. remove from back  \n";
           cout<<"7. print singly linked list  \n";
           cout<<"Enter your choice (press ll to exit) ---- : ";
           cin>>ch;
           switch(ch)
             { 
               case '1' : if(sll.empty())
